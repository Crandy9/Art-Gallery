/*
 * added razor page under custom Account folder under Pages For new users
...
namespace Kaoru_Art_Gallery.Pages.Account
{
    public class CreateAccountModel : PageModel
    {
        ...
        // on account creation, credentials gets sent here
        [BindProperty]
        public AccountCredential? AccountCredential { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (AccountCredential.UserName == "linden" && AccountCredential.Password == "password")
            {
                ...
                var authProperties = new AuthenticationProperties
                {
                    ...
                    // in Login.cshtml
                    //IsPersistent = AccountCredential.RememberMe
                };
